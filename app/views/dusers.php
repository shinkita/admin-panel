<div class="content-inner">
    ...
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">Deleted Users</h2>
        </div>
    </header>
    <div class="float-right m-2"><a href="<?= base_url().'users'?>" class="btn btn-primary">Users</a></div>
    <!--Breadcrumb-->
...
<script>
    ...
    function load_user(start = 0) {
        ...
        // console.log(s_input);      
        $.ajax({
            url:"<?=base_url().'ajax/deleted_load_data'?>",
            method:"POST",

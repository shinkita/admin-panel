                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    if(form_error('answer') != '')
                    {
					 ...
					 $category_name_value = (set_value('category') != '') ? set_value('category'):$faq['category_name'];
                    ?>
                    <form method="post">
                      <div class="form-row">
                        <div class="col">
                          <input type="text" class="form-control" name="category" placeholder="Category Name" value="<?php echo $category_name_value; ?>" required>
                        </div>

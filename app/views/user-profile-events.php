<div class="content-inner">
    ...
    <div class="breadcrumb-holder container-fluid">        
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">Profile Events</li>                        
        </ul>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-lg-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <h3>Posted Events</h3><small></small>                      
                            <div class="row">
                                <?php
										 ...
										 if($v['name']=='' )
								 {
								      ...
								      $CI =& get_instance();
										$CI->load->model('usersmodel');
										 ...
										 $event_user_id =  $CI->usersmodel->fetch_query("SELECT  user_id from  event_module where id='$event_id'");

...
<nav class="side-navbar">
          ...
          <ul class="list-unstyled"> 
             ...
             <!-- <li id="Merchant_pages"><a href="#merchant_drop" aria-expanded="false" data-toggle="collapse"><i class="icon-shop"></i>Merchant Pages</a></li>
			  ...
			  <li id="Setting">
                <a href="<?=base_url().'business'?>"><i class="icon-settings"></i>Feeds</a>
              </li>
			  
			   <li id="Setting">
                <a href="<?=base_url().'businessuser'?>"><i class="icon-settings"></i>Advertisers </a>
              </li>
			  <li id="Setting">
                <a href="<?=base_url().'category'?>"><i class="icon-settings"></i>Interests</a>
              </li>
